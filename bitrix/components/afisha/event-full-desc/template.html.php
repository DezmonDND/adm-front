  ...
  <div class="afisha-event__container"> 
    ...
    <div class="afisha-event__content"> 
      ...
      <div class="afisha-event__banner"> 
        <div class="afisha-event__banner-list" id="afisha-event__banner-list"><a class="swipebox" href="../img/banner.png" title="Первый слайд"><img class="afisha-event__image" src="/local/templates/surgut/img/banner.png" alt="Баннер события" onclick="showBigImage()"/></a><a class="swipebox" href="../img/banner_3.png" title="Второй слайд"><img class="afisha-event__image" src="/local/templates/surgut/img/banner_3.png" alt="Баннер события" onclick="showBigImage()"/></a></div>
