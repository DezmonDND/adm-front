...
<div class="archive-dm">
  <div class="archive-dm__container"> 
    <div class="hearing-item">
      ...
      <div class="hearing-item-content">
        <div class="hearing-item-title"><span>Постановления Администрации города от 01.06.2022 № 2816,01.06.2022 № 2817,01.06.2022 № 2818)</span></div>
  ...
  <div class="archive-dm__slider">
    <div class="slider"><a class="slider__link slider__archive-dm-prev">
        <ion-icon name="arrow-back-outline"></ion-icon></a><a class="slider__link slider__archive-dm-next">
