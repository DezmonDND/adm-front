...
<div class="user-profile"> 
  <button class="user-profile__button" onclick="changeAvatar()" type="button"> <img class="user-profile__avatar" src="/local/templates/surgut/img/user_avatar.png" alt="Аватар"/></button>
...
<div class="tabs">
  ...
  <div class="slider"><a class="slider__link slider__-prev">
      <ion-icon name="arrow-back-outline"></ion-icon></a><span class="slider__counter">   </span><a class="slider__link slider__-next">
