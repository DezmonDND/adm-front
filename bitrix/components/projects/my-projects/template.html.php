...
<div class="projects-array">
  <div class="projects-array__content projects-array__content">
    ...
    <div class="projects-array__save-buttons">
      <button class="button button_blue button_size_m  button_icon-left " onclick="deleteProject()" title=""><span class="button_span">Удалить</span>
        <ion-icon class="icon" name="trash-outline"></ion-icon>
      </button>
      <button class="button button_white button_size_m   " onclick="cancelEdit()" title=""><span class="button_span">Отмена</span>
      </button>
    </div>
  </div>
</div>