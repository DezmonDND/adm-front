...
<h2 class="main__title">Виртуальная приемная<span class="main__description">Информация о персональных данных авторов обращений, направленных в электронном виде, хранится и обрабатывается с соблюдением требований российского законодательства персональных данных. </span>
  <form class="virtual-receprion__form">
    <div class="virtual-receprion__content"> 
      ...
      <button class="button button_white button_add-author" onclick="getValues(event)"><span class="button_span">Добавить соавтора</span><img class="icon" src="/local/templates/surgut/icons/add-author-disabled_icon.svg" alt="add-author-disabled_icon.svg"/>
      </button>
      <div class="virtual-reception__form-field form-field form-field_inputs">
    ...
    <ul class="virtual-reception__documents__list">
      <li class="virtual-reception__document">
        <button class="button button virtual-reception__delete-button" onclick="getValues(event)"><span class="button_span"></span><img class="icon" src="/local/templates/surgut/icons/close-btn_icon.svg" alt="close-btn_icon.svg"/>
        </button>
        <div class="virtual-reception__document-description"> <img class="virtual-reception__document-icon" src="/local/templates/surgut/icons/doc-2_icon.svg" alt=""/><span class="virtual-reception__document-title">Отчёт о деятельности постоянных комитетов в 2023 году.pdf</span></div>
      </li>
      <li class="virtual-reception__document">
        <button class="button button virtual-reception__delete-button" onclick="getValues(event)"><span class="button_span"></span><img class="icon" src="/local/templates/surgut/icons/close-btn_icon.svg" alt="close-btn_icon.svg"/>
        </button>
