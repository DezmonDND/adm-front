...
<div class="reception">
  ...
  <form class="reception__form">
    <div class="reception__content"> 
      ...
      <button class="button button_white reception_add-author-btn   button_icon-left " onclick="addFormField(event)"><span class="button_span">Добавить соавтора</span>
      ...
      <fieldset class="fieldset">
        ...
        <div class="fieldset__answers">
          <div class="textarea__container">
            <textarea class="textarea  " placeholder="Введите ваш ответ" name="feedback" maxlength="900" oninput="getLength(this)"></textarea>
