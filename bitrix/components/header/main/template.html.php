...
<header class="header"> 
  ...
  <div class="header__bottom-content"><a class="header__main-links" href="/" role="link" title="Главная" aria-label="Главная страница"><img class="header__logo" src="/local/templates/surgut/icons/footer-logo_icon.svg" alt="Логотип"/>
    ...
    <ul class="header_links">
      ...
      <li class="header__link" role="link" aria-label="Контакты"> <a href="/" tabindex="-1">Контакты          </a></li>
    </ul>
  ...
  <div class="header-visibility__top-content"> 
    ...
    <div class="header-visibility__top-links">
      <ul class="header_links">
        <li class="header__link" role="link" aria-label="О Сургуте"> <a href="/" tabindex="-1">О Сургуте          </a></li>
        <li class="header__link" role="link" aria-label="Городская власть"> <a href="/" tabindex="-1">Городская власть          </a></li>
        <li class="header__link" role="link" aria-label="Документы"> <a href="/" tabindex="-1">Документы          </a></li>
        <li class="header__link" role="link" aria-label="Контакты"> <a href="/" tabindex="-1">Контакты          </a></li>
      </ul>
      <div class="header__socials"><a class="header__social-icon vk_icon" href="/" title="Ссылка на социальные сети Вконтакте" role="link"></a><a class="header__social-icon ok_icon" href="/" title="Ссылка на социальные сети Одноклассники" role="link"></a><a class="header__social-icon tg_icon" href="/" title="Ссылка на социальные сети Телеграмм" role="link"></a>
      </div>
  ...
  <div class="header-visibility__bottom-content">
    <ul class="header_links">
      <li class="header__link" role="link" aria-label="Быстрый доступ"> <a href="/" tabindex="-1">Быстрый доступ          </a></li>
      <li class="header__link" role="link" aria-label="Публичные слушания"> <a href="/" tabindex="-1">Публичные слушания          </a></li>
      <li class="header__link" role="link" aria-label="Противодействие коррупции"> <a href="/" tabindex="-1">Противодействие коррупции          </a></li>
      <li class="header__link" role="link" aria-label="Пресс-центр"> <a href="/" tabindex="-1">Пресс-центр          </a></li>
      <li class="header__link" role="link" aria-label="Обращения граждан"> <a href="/" tabindex="-1">Обращения граждан          </a></li>
    </ul>
  </div>
</header>
