...
<form class="interview-form">
  ...
  <button class="button button_blue button_interview button_blue button_interview button_icon-undefined " onclick="getValues(event)"><span class="button_span">Отправить форму</span>
