  ...
  <div class="select_multiple_container">
    <div class="select select_multiple" onclick="openSelect()">
      ...
      <ul class="select_multiple_options"> 
        <div class="select_multiple_option"><span>Филатов Андрей Сергеевич, Глава города Сургута </span>
          <button class="button select__delete-button" onclick="deleteOption()"><span class="button_span"></span></button>
        </div>
        <div class="select_multiple_option"> <span>Филатов Андрей Сергеевич </span>
          <button class="button select__delete-button" onclick="deleteOption()"><span class="button_span"></span></button>
        </div>
      </ul>
    </div>
