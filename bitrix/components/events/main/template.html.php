      ...
      <div class="full-width-content">                                            
        <div class="events__container"> 
          ...
          <div class="filters-popup">
            <div class="filters-popup__container"> 
              ...
              <div class="filters-popup__calendar"><span class="filters-popup__title">Выберите период публикации                  </span>
                <div class="calendar-dm" id="events-calendar-popup" aria-label="Календарь для выбора дат" tabindex="0"></div>
              </div>
          ...
          <div class="events__calendar"> 
            <div class="calendar-dm" id="events-calendar" aria-label="Календарь для выбора дат" tabindex="0"></div>
          </div>
          ...
          <div class="events__news" id="events__news"><a class="news-main-card" href="/" title="Памятный знак для будущего «Сургутского кремля» создадут горожане" role="link">
          ...
          <div class="events__navigation">
            <div class="navigation"> <a class="navigation__link" role="button" aria-label="Назад">
              ...
              <div class="navigation__pages"><span class="navigation__page" aria-label="Страница 1" tabindex="0">1</span><span class="navigation__page">/</span><span class="navigation__page" aria-label="Из 7" tabindex="0">7</span></div><a class="navigation__link" role="button" aria-label="Вперед">
